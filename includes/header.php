    ...
    <div class="mobile-navigation" id="mobile-navigation">
        <div class="mobile-navigation-header">
            ...
            <div class="main-logo-container">
                <a href=""><img src="img/drnklogowhite.png" class="main-logo-picture" alt=""></a>
            </div>
        </div>
        ...
        <div class="links-container">
            ...
            <a href="index" class="mobile-navigation-item">Home</a>
            <a href="menu" class="mobile-navigation-item">Menu</a>
            <a href="about" class="mobile-navigation-item">About</a>
            <a href="contact" class="mobile-navigation-item">Contact</a>
            <a href="blog" class="mobile-navigation-item">Blog</a>

            <?php if(isset($_SESSION['auth'])) { ?>
                <div class="nav-admin">
                    <a href="espressyourself">EspressYourSelf</a>
                </div>
            <?php } ?>
        </div>
    ...
    <div id="container">
        <header>
            <div class="navigation-container">
                ...
                <div class="main-logo-container">
                    <a href="index"><img src="img/drnklogo.png" alt="" class="main-logo-picture"></a>
                </div>
