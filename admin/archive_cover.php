                                            ...
                                            if(mysqli_num_rows($images) > 0) {
                                                ...
                                                foreach ($images as $image) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="../uploadsArchive/<?= $image['image']; ?>" alt="<?= $image['name']; ?>"></td>
                                                        <td><?= $image['status'] == 0 ? "Visible":"Hidden";?></td>
                                                        <td><?= $image['added_by']; ?></td>
                                                        <td><?= $image['created_at']; ?></td>
                                                        <td class="table-edit-delete">
                                                            <button type="button" class="btn btn-success recover_photo_btn" value="<?= $image['id']; ?>">Recover</button>
                                                            <button type="button" class="btn btn-danger delete_permanent_photo_btn" value="<?= $image['id']; ?>">Delete</button>
                                                        </td>
                                                    </tr>
