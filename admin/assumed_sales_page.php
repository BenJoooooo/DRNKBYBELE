                        ...
                        <?php include('../functions/sessionmessage.php'); ?>
                            ...
                            <div class="card-header">
                                ...
                                <form action="../functions/export.php" method="POST">
                                    <button type="submit" value="CSV" name="export_assumed_sales" class="btn btn-success">Export CSV</button>
                                </form>
                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $data = getAssumedTotalSales("orders");
                                        ...
                                        <?php
                                                ...
                                                $total = getAssumedTotalSalesPrice("orders");
