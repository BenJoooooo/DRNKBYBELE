                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $images = getAll("archive_blogsindustry");
                                            if(mysqli_num_rows($images) > 0) {
                                                ...
                                                foreach ($images as $image) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="../uploadsArchiveBlogs/<?= $image['image']; ?>" alt="<?= $image['title']; ?>"></td>
                                                        <td><?= $image['posted'] == 0 ? "Visible":"Hidden";?></td>
                                                        <td><?= $image['added_by']; ?></td>
                                                        <td><?= $image['created_at']; ?></td>
                                                        <td class="table-edit-delete">
                                                            <button type="button" class="btn btn-success recover_industryblogs_btn" value="<?= $image['id']; ?>">Recover</button>
                                                            <button type="button" class="btn btn-danger delete_permanent_industryblogs_btn" value="<?= $image['id']; ?>">Delete</button>
                                                        </td>
                                                    </tr>
