                        ...
                        <div class="table-container">
                            ...
                            <div class="card-header">
                                ...
                                <form action="../functions/export.php" method="POST">
                                    <button type="submit" value="CSV" name="export_year_sales" class="btn btn-success">Export CSV</button>
                                </form>
                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $data = getTotalOfYearPrice("orders");
                                            if(mysqli_num_rows($data) > 0) {
                                                ...
                                                foreach ($data as $item) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-justify">
                                                            <a href="yearly_sales?year=<?= $item['created_at'];?>" class="btn btn-success">View</a>

                                                            <form action="../functions/export.php" method="POST">
                                                                <button type="submit" value="<?= $item['created_at']; ?>" name="year_sales" class="btn btn-success">Export CSV</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                        <?php
                            ...
                            <?php 
                                ...
                                $chartMonth = getYearChart("orders");
