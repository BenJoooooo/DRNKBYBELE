                        ...
                        <div class="table-container">
                            ...
                            <div class="card-header">
                                ...
                                <form action="../functions/export.php" method="POST">
                                    <button type="submit" value="CSV" name="export_csv" class="btn btn-success">Export CSV</button>
                                </form>
                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $data = getSalesByOrderComplete("orders");
                                        ...
                                        <?php
                                                ...
                                                $total = getTotalOfCompleteSales("orders");
                            ...
                            <?php 
                                ...
                                $chartMonth = getProductDayChart();
                                foreach($chartMonth AS $data) {
                                    $day[] = $data['products_name'];
                                    $amount[] = $data['amount'];
                                }
