                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $images = getAll("archive_blogsabout");
                                                ...
                                                foreach ($images as $image) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-edit-delete">
                                                            <button type="button" class="btn btn-success recover_aboutblogs_btn" value="<?= $image['id']; ?>">Recover</button>
                                                            <button type="button" class="btn btn-danger delete_permanent_aboutblogs_btn" value="<?= $image['id']; ?>">Delete</button>
                                                        </td>
                                                    </tr>
