                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $data = getOrdersArchive("archive_orders");
                                            if(mysqli_num_rows($data) > 0) {
                                                ...
                                                foreach ($data as $item) { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-justify">
                                                            <button class="btn btn-success recoverOrder" value="<?= $item['id']; ?>">Recover</button>
                                                            <button class="btn btn-danger deleteOrderPermanent" value="<?= $item['id']; ?>">Permanently Delete</button>
                                                        </td>
