                        ...
                        <?php include('../functions/sessionmessage.php'); ?>
                            ...
                            <div class="card-header">
                                ...
                                <form action="../functions/export.php" method="POST">
                                    <button type="submit" value="CSV" name="failed_sales_day" class="btn btn-success">Export CSV</button>
                                </form>
                            ...
                            <div class="card-body" id="coverphotos_table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $data = getSalesByOrderFailed("orders");
                                        ...
                                        <?php
                                                ...
                                                $total = getTotalOfFailedSales("orders");
                                                if(mysqli_num_rows($total) > 0) {
                                                    foreach($total as $total_price) {
                                        ?>

                                                    <tr>
                                                        <td>Total Failed Sales</td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
