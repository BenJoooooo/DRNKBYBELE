                        ...
                        <div class="card-body" id="category_table">
                            <table>
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        $category_data = getAll("archive_categories");
                                        if(mysqli_num_rows($category_data) > 0) {
                                            ...
                                            foreach ($category_data as $data) { ?>
                                                ...
                                                <tr>
                                                    <!-- <td><?= $data['id']; ?></td> -->
                                                    <td><?= $data['name']; ?></td>
                                                    <td><img src="../uploadsArchiveCategories/<?= $data['image']; ?>" alt=""></td>
                                                    <!-- <td><?= $data['slug']; ?></td> -->
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success recover_category_btn" value="<?= $data['id']; ?>">Recover</button>
                                                        <button type="button" class="btn btn-danger delete_category_permanent_btn" value="<?= $data['id']; ?>">Delete</button>
                                                    </td>
                                                </tr>
